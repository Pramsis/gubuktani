  ...
  <div class="view-data">
    ...
    <?php
        ...
        if(isset($_GET['cari'])){
          ...
          $limit = 9;
          $sql = "SELECT * FROM tb_lahan INNER JOIN tb_kategori ON tb_lahan.id_kategori=tb_kategori.id_kategori WHERE status = 'Terverifikasi' ORDER BY fieldCreate_at DESC";
          $query = $db->prepare($sql);
          $query->execute();
