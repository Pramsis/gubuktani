<?php
    ...
    $show = "SELECT * FROM tb_kategori ORDER BY create_at DESC LIMIT $starting_limit , $limit";
    ...
    <div id="myModal" class="modal">
      <div class="modal-content">
        <div class="modal-header">
          ...
          <h2><i class="fa fa-plus"></i> Tambah Data Kategori</h2>
        </div>
        <div class="modal-body">
          <form action="catProses.php" method="post" class="form-tambah" enctype="multipart/form-data">
              <input type="text" id="lname" name="kategori" placeholder="Masukkan Kategori"  required/>
    ...
    <div style="overflow-x:auto;">
      <table id="myTable">
        ...
        <tr>
          ...
          <td>
            <a href="catEdit.php?id_kategori=<?php echo $value['id_kategori']; ?>" class="btn act info"><i class="fa fa-pencil"></i></a>
            <a href="catProses.php?id_kategori=<?php echo $value['id_kategori']; ?>" class="btn act danger"><i class="fa fa-trash"></i></a>
          </td>
        </tr>
        <?php endforeach; ?>
        <tr>
